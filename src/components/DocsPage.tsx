    ...
    return (
      <div className="max-w-4xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          ...
          through the installation process and help you get your first music bot
          running in minutes. AquaLink is designed for both beginners and
          experienced developers, offering a powerful yet easy-to-use interface
          for Lavalink.
        </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4">
            Before using AquaLink, you need a running Lavalink server. You can
            download the latest <code>Lavalink.jar</code> from the{' '}
            <a
            ...
            . Create an <code>application.yml</code> file in the same directory
  ...
  level:
    ...
    lavalink: INFO`}
          ...
          <p className="text-muted-foreground mt-4">
            Run Lavalink using <code>java -jar Lavalink.jar</code>. For more
            advanced configurations, refer to the{' '}
            <a
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4">
            ...
            Lavalink. Make sure to replace `'YOUR_BOT_TOKEN'` with your actual
            bot token.
          </p>
          <CodeBlock
            onCopy={() =>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Built on Lavalink for optimal performance and reliability
                </p>
              </CardContent>
            </Card>
          </div>
  ...
  if (activeSection === 'initialization') {
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          Proper initialization is key to a stable and reliable music bot. This
          section covers the essential steps to configure AquaLink and connect
          it to your Discord bot instance.
        </p>
...
const { Aqua } = require('aqualink');`}
    ...
    console.log('Aqua is ready!');
          ...
          <div className="mb-8">
            ...
            <CodeBlock
              onCopy={() => copyToClipboard(`client.login('YOUR_BOT_TOKEN');`)}
            >
              client.login('YOUR_BOT_TOKEN');
            </CodeBlock>
          </div>
  ...
  if (activeSection === 'player') {
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          The Player class is the heart of AquaLink's music functionality. It
          manages everything related to a single guild's music session, from
          connection and playback to volume and state.
        </p>
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-6">Creating a Player</h2>
          <p className="text-muted-foreground mb-4">
            To start using the player, you first need to create a connection.
            This is typically done when a user runs a play command. If a player
            already exists for the guild, you can retrieve it using `getPlayer`.
          </p>
          <CodeBlock
            onCopy={() =>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { name: 'ping', type: 'number', desc: 'Player ping in ms' },
              {
...
player.pause(false); // Resume`}
            ...
            <div>
              ...
              <CodeBlock
                onCopy={() =>
                  copyToClipboard(`player.seek(60000); // Seek to 1 minute`)
                }
              >
            ...
            <div>
              ...
              <CodeBlock
                onCopy={() =>
                  copyToClipboard(`player.setVolume(50); // 50% volume`)
                }
              >
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3">disconnect()</h3>
              <p className="text-muted-foreground mb-3">
                Disconnect the player from the voice channel
              </p>
              <CodeBlock onCopy={() => copyToClipboard(`player.disconnect();`)}>
                player.disconnect();
              </CodeBlock>
            </div>
            <div>
              ...
              <CodeBlock onCopy={() => copyToClipboard(`player.shuffle();`)}>
                player.shuffle();
              </CodeBlock>
            </div>
            <div>
              ...
              <CodeBlock onCopy={() => copyToClipboard(`player.replay();`)}>
                player.replay();
              </CodeBlock>
            </div>
            <div>
              ...
              <CodeBlock onCopy={() => copyToClipboard(`player.getLyrics();`)}>
                player.getLyrics();
              </CodeBlock>
            </div>
            <div>
              ...
              <CodeBlock
                onCopy={() => copyToClipboard(`player.subscribeLiveLyrics();`)}
              >
            ...
            <div>
              ...
              <CodeBlock onCopy={() => copyToClipboard(`player.autoplay();`)}>
                player.autoplay();
              </CodeBlock>
            </div>
          </div>
  ...
  if (activeSection === 'queue-class') {
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          The Queue class provides a robust set of tools for managing your music
          queue. You can add, remove, shuffle, and inspect tracks with ease.
        </p>
...
<section className="mb-10">
  ...
  <section className="mb-10">
    ...
    <CodeBlock onCopy={() => copyToClipboard('const track = player.queue.peek();')}>
  ...
  <section className="mb-10">
    ...
    <CodeBlock onCopy={() => copyToClipboard('const firstTrack = player.queue.first();')}>
  ...
  <section className="mb-10">
    ...
    <CodeBlock onCopy={() => copyToClipboard('const lastTrack = player.queue.last();')}>
  ...
  <section className="mb-10">
    ...
    <CodeBlock onCopy={() => copyToClipboard('const track = player.queue.at(1);')}>
  ...
  <section className="mb-10">
    ...
    <CodeBlock onCopy={() => copyToClipboard('player.queue.enqueue(track);')}>
  ...
  <section className="mb-10">
    ...
    <CodeBlock onCopy={() => copyToClipboard('const track = player.queue.dequeue();')}>
  ...
  <section className="mb-10">
    ...
    <CodeBlock onCopy={() => copyToClipboard('const empty = player.queue.isEmpty();')}>
  ...
  <section className="mb-10">
    ...
    <div className="mb-6">
      ...
      <CodeBlock
        onCopy={() =>
          copyToClipboard('console.log(player.queue.size); // Queue size')
        }
      >
  ...
  if (activeSection === 'node-class') {
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          The Node class represents a connection to a Lavalink server. You can
          manage multiple nodes, monitor their status, and handle failover
          scenarios.
        </p>
  ...
  requestTimeout: 10000
        ...
        <section className="mb-10">
          ...
          <div className="mb-6">
            ...
            <CodeBlock
              onCopy={() =>
                copyToClipboard('console.log(node.connected); // true/false')
              }
            >
  ...
  if (activeSection === 'playing-tracks') {
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          This section demonstrates how to search for and play tracks. It covers
          the entire process from handling a user command to getting music
        ...
        <section className="mb-12">
          ...
          <p className="text-muted-foreground mb-4">
            This example shows a complete play command for a Discord bot using
            slash commands.
          </p>
          <CodeBlock
            onCopy={() =>
  ...
  if (activeSection === 'searching') {
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          Search for tracks across different platforms and handle various search
          result types.
        </p>
  ...
  if (activeSection === 'playback-control') {
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          Control audio playback with play, pause, skip, volume, and seeking
          functions.
        </p>
    ...
    return (
      <div className="max-w-5xl">
        ...
        <p className="text-lg text-muted-foreground mb-12">
          ...
          state of your music players and Lavalink nodes. You can listen for
          these events to build a responsive and interactive bot.
        </p>
...
if (!node.connected) {
    console.log('Node is not connected');
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  Ensure bot has proper permissions to join voice channels.
                </p>
                <CodeBlock
                  onCopy={() =>
...
if (!permissions.has('Connect') || !permissions.has('Speak')) {
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-sm">
                Solution: Check node configuration and ensure Lavalink server is
                running
              </p>
            </div>
            ...
            <div className="border border-border rounded-lg p-4">
              ...
              <p className="text-sm">
                Solution: Create a player connection first before controlling
                playback
              </p>
            </div>
          </div>
  ...
  return (
    <div className="max-w-6xl">
      ...
      <p className="text-lg text-muted-foreground mb-12">
        Welcome to AquaLink! A powerful Discord music bot library built on top
        of Lavalink.
      </p>
